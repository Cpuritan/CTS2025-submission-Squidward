...
# --- 全局参数与新约束常量 ---
PROACTIVE_POSITIONING_START_DATE = datetime.datetime(2025, 4, 29, 0, 0)
OPTIMIZATION_START_DATE = datetime.datetime(2025, 5, 1, 0, 0)
OPTIMIZATION_END_DATE = datetime.datetime(2025, 5, 7, 23, 59, 59)
...
TASK_STEALING_ITERATIONS_STAGE_2 = 25000
