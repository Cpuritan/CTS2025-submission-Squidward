...
# --- 全局参数与新约束常量 ---
PROACTIVE_POSITIONING_START_DATE = datetime.datetime(2025, 1, 30, 0, 0)
OPTIMIZATION_START_DATE = datetime.datetime(2025, 2, 2, 0, 0)
OPTIMIZATION_END_DATE = datetime.datetime(2025, 2, 8, 23, 59, 59)
...
TASK_STEALING_ITERATIONS_STAGE_2 = 18000
...
class CrewScheduler:
    ...
    def solve(self):
        ...
        temperature, alpha, MAX_ITERATIONS = 1000.0, 0.999, 1000
